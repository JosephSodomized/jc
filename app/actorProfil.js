...
function actorPanel(person, age) {
  ...
  html = ` <div class="row pt-3">
      ...
      <div class="row py-1">
        ...
        <div class="col">
          ...
          <div class="input-group input-group-sm">
            ...
            <div class="input-group-append">
              <button class="btn btn-sm btn-danger add_comment" type=""button><span class="my-auto" style="font-size: 12px;">Uwagi</span></button>
          </div>
          </div>
        </div>
      </div>
    ...
    <div class="col">
      ...
      <div class="row py-1">
        ...
        <!-- Uwagi ocena -->
      <div class="row py-1 grade_comments" style="display:none">
          <div class="col">
  ...
  <div class="row">
      <div class="col text-right">
        <p style="font-size:10px;">Utworzone przez: `+ person.WhoCreated + ` Ostatnia edycja: ` + person.CreationDate + ` Edytował: ` + person.WhoChanged + `</p>  
        </div>
      </div>`;
